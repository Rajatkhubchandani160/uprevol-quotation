...
const Editproduct = ({onclose,productdata,fetchData}) => {
  ...
  return (
    <div className='fixed z-10 bottom-0 top-0 left-0 right-0  flex justify-center items-center '>
      
      <div className='bg-white overflow-y-scroll mt-20 h-[70%] ml-[22%]  shadow-lg w-[45%] text-lg capitalize'>
        <div className='text-2xl font-bold p-1 flex bg-white border-b-2 border-black h-8 w-full items-center justify-between '>
        ...
        <form className='grid p-3 w-full gap-1 capitalize' onSubmit={HandleSubmitButton}>
          ...
          <div>
            ...
            <button className='mt-5 hover:bg-slate-400 bg-slate-200 px-2 py-1 rounded-xl ml-64'>Update Changes</button>
          </div>
        </form>
      </div>
